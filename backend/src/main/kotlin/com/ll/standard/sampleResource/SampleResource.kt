...
enum class SampleResource(
    ...
    val fileExt: String = com.ll.standard.util.Ut.file.getFileExt(fileName)
    val fileExtTypeCode: String = com.ll.standard.util.Ut.file.getFileExtTypeCodeFromFileExt(fileExt)
    val fileExtType2Code: String = com.ll.standard.util.Ut.file.getFileExtType2CodeFromFileExt(fileExt)
    ...
    fun makeCopy(): String {
        ...
        com.ll.standard.util.Ut.file.copy(getFilePath(), newFilePath)
        return newFilePath
    }

    fun getOriginalFileName(): String = fileName

    fun getContentType(): String = com.ll.standard.util.Ut.file.getContentType(fileExt)
}